...
public class signup extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Acer\\OneDrive\\Desktop\\spendingtracker\\5599504sign.png")); // NOI18N

        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Acer\\OneDrive\\Desktop\\spendingtracker\\username.png")); // NOI18N

        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setIcon(new javax.swing.ImageIcon("C:\\Users\\Acer\\OneDrive\\Desktop\\spendingtracker\\password.png")); // NOI18N
    ...
    String s1 = createusername.getText();
    String s2 = createpassword.getText();

    if (!isPasswordValid(s2)) {
        createpassword.setBackground(Color.RED);
        JOptionPane.showMessageDialog(this, "Password does not meet the requirements.");
        return;
    }
    else{
        createpassword.setBackground(Color.CYAN);
    try {
        db.DbConnect.st.executeUpdate("insert into login_info(id,Password) values('"+s1+"','"+s2+"')");
